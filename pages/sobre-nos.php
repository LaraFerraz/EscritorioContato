  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="images/escritorio.png" class="img-fluid rounded shadow" alt="Foto do escritório">
      </div>
      ...
      <div class="col-md-6">
        ...
        <p>
          Aqui, cada cliente é único — e nossa missão é entender suas necessidades com profundidade para oferecer muito mais do que um serviço: <strong>oferecer tranquilidade, clareza e parceria em cada decisão</strong>.
        </p>
      </div>
